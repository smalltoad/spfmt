...
#/**
# [DESCRIPTION]
# BATS tests for the get_current_directory function in the editorconfig.awk module.
#
...
#     2: T || F = T
#     4: F || F = F
# While B remains constant, changing A independantly changes the outcome.
#
...
@test "[TEST] get_current_directory MC/DC test case 2 (T||F should return T)" {
    expected="."
...
@test "[TEST] get_current_directory MC/DC test case 3 (F||T should return T)" {
    expected="."
...
@test "[TEST] get_current_directory MC/DC test case 4 (F||F should return F)" {
...
@test "[TEST] get_current_directory returns "." when AWK pwd is unset" {
