...
@test "${MAGENTA}[TEST] test_with_flag MC/DC test case for T||F should return T${RESET}" {
    tmp_file=""
    flag="f"
    expected="1"
...
@test "${MAGENTA}[TEST] test_with_flag MC/DC test case for F||T should return T${RESET}" {
    tmp_file=$(mktemp)
    flag=""
    expected="1"
...
@test "${MAGENTA}[TEST] test_with_flag MC/DC test case for F||F should return F${RESET}" {
    tmp_file=$(mktemp)
    flag="f"
    expected="0"
